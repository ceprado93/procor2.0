    ...
    return (
      <div id="politicas">
        <section>
          ...
          <p>
            Para cualquier consulta relacionaza para envíos a otras comunidades o provincias fuera de la península u otros países, rogamos se ponga en contacto en el télefono (+34) 913 43 65 16 o en
            el correo pedidos@procorlab.es
          </p>
